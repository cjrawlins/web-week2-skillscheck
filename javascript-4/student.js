...
let me = {
    firstName: 'Casey',
    superHeroName: 'The Javascriptanator',
    homeTown: 'The land of bits and bytes',
    superPowers: ['Make Lego Deadpool Dance', 'Create a much cooler web', 'Make devs pull thier hair out'],
